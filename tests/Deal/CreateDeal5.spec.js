...
await page.getByPlaceholder('name').first().fill('Kunal');

// Enter the organization name 
const orgField = page.getByPlaceholder('name').nth(1);
await orgField.click();
await orgField.type('Google India');
await page.waitForTimeout(1000);
...
await phoneInput.fill('34738284738');
await page.waitForTimeout(500);
...
await emailInput.fill('kunal.appnox@gmail.com');
await page.waitForTimeout(300);
