...
test("valid login", async function ({ page }) {
    ...
    // click on the dropdown to see the option 

await page.locator('#export-history-object-type').selectOption({ label: 'Deals' });

// select the lead from the dropdown
await page.locator('#export-history-object-type').selectOption({ label: 'Leads' });

// click on delete button 
   await page.getByTitle('Delete this export').nth(1).click();   
...
// Take final screenshot
    await page.screenshot({ path: 'screenshots/DeleteLeadsExport-end.png' });
