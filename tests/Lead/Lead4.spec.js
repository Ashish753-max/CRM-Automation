...
await page.getByPlaceholder('name').first().fill('Aman');

// Enter the organization name 
const orgField = page.getByPlaceholder('name').nth(1);
await orgField.click();
await orgField.type('Pipeclose AI');
await page.waitForTimeout(1000);
...
await page.getByPlaceholder("Details about the lead's needs...").fill('B2B Saas System');
await page.waitForTimeout(1500);

// Enter the phone number
await page.getByPlaceholder('Phone number').fill('8998399233');
await page.waitForTimeout(1500);

// Enter the email
await page.getByPlaceholder('Email').fill('aman.appnox@gmail.com');
await page.waitForTimeout(1500);
...
await page.screenshot({ path: 'screenshots/Lead4-Created-Successfully.png' });
console.log('✓ Screenshot saved: screenshots/Lead4-Created-Successfully.png');
