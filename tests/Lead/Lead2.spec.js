...
await page.getByPlaceholder('name').first().fill('Shivang');

// Enter the organization name 
const orgField = page.getByPlaceholder('name').nth(1);
await orgField.click();
await orgField.type('Appnox AI');
await page.waitForTimeout(1000);
...
await page.getByPlaceholder("Details about the lead's needs...").fill('AI Development Services');
await page.waitForTimeout(1500);

// Enter the phone number
await page.getByPlaceholder('Phone number').fill('7089832938');
await page.waitForTimeout(1500);

// Enter the email
await page.getByPlaceholder('Email').fill('shivang.appnox@gmail.com');
await page.waitForTimeout(1500);
...
await page.screenshot({ path: 'screenshots/Lead2-Created-Successfully.png' });
console.log('✓ Screenshot saved: screenshots/Lead2-Created-Successfully.png');
